            ...
            >
              ...
              <DropdownMenu right className={`${s.dropdownMenu} ${s.support}`}>
                <DropdownItem>
                  ...
                  <div className={s.details}>Your Goal EMI is due today</div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="warning">
                    <i className="fa fa-question-circle" />
                  </Badge>
                  <div className={s.details}>Check out our EXPERT's Advice </div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="success">
                ...
                <DropdownItem>
                  ...
                  <div className={s.details}>50 coins credited</div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="danger">
